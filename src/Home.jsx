...
const DUMMY_STORES = [
    ...
    },
    {
        ...
        lng: 126.9080,
        issue: '주휴수당 미지급 의심',
        oxStats: '근로계약서 O (5건) / 주휴수당 X (4건)',
        reviewCount: 9,
        frequentJobs: ['오픈 파트타이머']
    },
    {
        id: 4,
        name: '후문 XX식당',
        ...
        stores.forEach((store) => {
            ...
            const svgMarker = `
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="40" viewBox="0 0 24 35">
                    <path fill="${color}" d="M12 0C5.373 0 0 5.373 0 12c0 7.747 12 23 12 23s12-15.253 12-23C24 5.373 18.627 0 12 0zm0 17c-2.761 0-5-2.239-5-5s2.239-5 5-5 5 2.239 5 5-2.239 5-5 5z"/>
                </svg>
            `;
            ...
            <div style={contentStyle}>
                        ...
                        <div style={popupStyle}>
                            ...
                            >
                                <h3 style={{ margin: 0, fontSize: '18px', color: '#333' }}>
                                    <span
                                        style={{
                                            ...statusDotStyle,
                                            backgroundColor: getCleanGradeInfo(
                                                selectedStore.cleanIndex
                                            ).color
                                        }}
                                    />
                                    {selectedStore.name}
                            ...
                            <div style={infoRowStyle}>
                                ...
                                <span
                                    style={{
                                        fontWeight: 'bold',
                                        color: getCleanGradeInfo(selectedStore.cleanIndex)
                                            .color
                                    }}
                                >
                            ...
                            <div style={infoRowStyle}>
                                ...
                                <span style={{ fontSize: '13px', color: '#555' }}>
                                    {selectedStore.reviewCount}명 참여
                                </span>
                            </div>
                ...
                <div style={sidebarStyle}>
                    ...
                    <div style={listContainerStyle}>
                        {stores.length > 0 ? (
                            stores.map((store) => {
                                const gradeInfo = getCleanGradeInfo(store.cleanIndex);
